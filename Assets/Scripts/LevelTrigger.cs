...
// вызвать LevelTrigger.ForceMoveTo
...
// в On Click () кнопки добавить вызов LevelTrigger.ForceMoveTo
public class LevelTrigger : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            Debug.Log($"SET Trigger Component and Level ID for {gameObject.name} button!!!");
        } else
        {
